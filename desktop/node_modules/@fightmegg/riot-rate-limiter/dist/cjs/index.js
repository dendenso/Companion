...
class RiotRateLimiter {
    ...
    async syncRateLimiters(region, method, rateLimits) {
        ...
        if ((_a = this.rateLimiters[region]) === null || _a === void 0 ? void 0 : _a[method]) {
            ...
            this.rateLimiters[region][method].limiters = await rate_limiter_1.synchronizeRateLimiters(this.rateLimiters[region][method].limiters, { limits: rateLimits.methodLimits, counts: rateLimits.methodCounts }, this.rateLimiters[region][method].main.counts());
        }
        return;
    }
