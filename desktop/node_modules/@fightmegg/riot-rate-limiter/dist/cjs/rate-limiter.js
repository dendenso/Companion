...
exports.createRateLimiters = (rateLimits, opts) => {
...
exports.createRateLimitRetry = (limitType, retryAfterDefault, retryLimit) => (err, jobInfo) => {
...
exports.updateRateLimiters = (rateLimiters, rateLimits) => {
    const { limits, counts } = rateLimits;
    const limitsArr = limits.split(",");
    const countsArr = counts.split(",");
...
exports.synchronizeRateLimiters = async (rateLimiters, rateLimits, methodCounts) => {
    const { limits, counts } = rateLimits;
    const limitsArr = limits.split(",");
    const countsArr = counts.split(",");
